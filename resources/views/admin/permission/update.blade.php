    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Update Permission</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" value="{{$data['row']->name}}" placeholder="Enter permission name" name="name"
    ...
    @section('script')
      <script type="module">
        $("#form").validate({
            ...
            messages: {
                name: 'Please enter a permission name',
