<x-admin.app>
    ...
    <div class="col-grid-12 bg-white rounded shadow-2 p-4 dark:bg-boxdark">
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form action="{{route('admin.user.post.update',$data['row']->id)}}" method="POST">
                @csrf
                <div class="p-6.5">
                    <div class="mb-4.5">
                    ...
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" placeholder="Enter your first name" name="name" value="{{$data['row']->name}}"
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="email" placeholder="Enter your email address" name="email" value="{{$data['row']->email}}"
                            class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                    </div>
                    <div class="mb-4.5">
                        <label class="mb-2.5 block text-black dark:text-white">
