<x-admin.app>
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">All Jobs</li>
            </ol>
        </nav>
    </div>
                ...
                <tbody>
                    @foreach($data['rows'] as $row)
                        <tr
                            ...
                            <td class="border-b border-l border-[#eee] p-2 dark:border-strokedark">
                                <h5 class="font-medium text-black dark:text-white">{{ $row->comments }}</h5>
                            </td>
                            <td class="border-b border-l border-[#eee] p-2 dark:border-strokedark">
                            ...
                            <td class="border-b border-l border-[#eee] p-2 dark:border-strokedark">
                                <div class="flex items-center space-x-3.5">
                                    ...
                                    <x-admin.button.delete :row="$row" :action="route('admin.job.delete',$row->id)">
    ...
    <script type="module">
        $('.show_confirm').click(function (event) {
            ...
            Swal.fire({
                title: '<span class="leading-10">Are you sure, You want to delete this user?</span>',
