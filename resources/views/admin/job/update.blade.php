    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Update Job</li>
            </ol>
        </nav>
    </div>
            ...
            <form action="{{route('admin.job.post.update',$data['row']->id)}}" method="POST" id="form">
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5">
                        ...
                        <textarea rows="6" name="description" placeholder="Enter Job Description Here..." class="w-full rounded-lg border-[1.5px] border-primary bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:bg-form-input" spellcheck="false">{{$data['row']->description}}</textarea>
                    </div>
                    <div class="mb-4.5">
                        <label class="mb-2.5 block text-black dark:text-white">
                            Comment
                        </label>
                        <input type="text" value="{{$data['row']->comments}}" placeholder="Enter Job Title" name="comments"
                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                    </div>
                    <div class="mb-4.5">
                        <label class="mb-2.5 block text-black dark:text-white">
